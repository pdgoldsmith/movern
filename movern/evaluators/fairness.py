...
from movern.evaluators.performance import create_confusion_matrix
...
class ModelFairness(Evaluator):
    ...
    ------------------
        **Required Artifacts**
        ...
        - model: :class:`movern.artifacts.Model` or :class:`movern.artifacts.RegressionModel`
        - data: :class:`movern.artifacts.TabularData`
