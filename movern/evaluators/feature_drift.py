...
from movern.evaluators.utils.validation import check_requirements_existence
from movern.modules.metrics_movern import population_stability_index
...
class FeatureDrift(Evaluator):
    ...
    ------------------
        **Required Artifacts**
        ...
        - training_data: :class:`movern.artifacts.TabularData`
