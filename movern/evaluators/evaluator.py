...
from movern import __version__ as version
from movern.utils import global_logger
from movern.utils.common import NotRunError, ValidationError
...
class Evaluator(ABC):
    ...
    def required_artifacts(self):
        ...
        This set contains the :ref:`artifacts<movern.artifacts>` that Lens can feed to
