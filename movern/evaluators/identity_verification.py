...
from movern.artifacts import ComparisonData, ComparisonModel
...
from movern.evaluators.utils.validation import (
    check_data_instance,
    check_existence,
    check_model_instance,
)
from movern.modules.constants_metrics import BINARY_CLASSIFICATION_FUNCTIONS as bcf
from movern.modules.metrics import Metric
...
class IdentityVerification(Evaluator):
    ...
    ------------------
        **Required Artifacts**
        ...
        model: :class:`movern.artifacts.ComparisonModel`
        assessment_data: :class:`movern.artifacts.ComparisonData`
    ...
    >>> from movern.artifacts import ComparisonData, ComparisonModel
    >>> from movern.evaluators import IdentityVerification
