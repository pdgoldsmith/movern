...
from movern.artifacts.model.constants_model import MODEL_TYPES
from movern.modules.constants_metrics import *
from movern.modules.constants_threshold_metrics import *
from movern.utils.common import ValidationError, humanize_label, wrap_list
    ...
    for metric in metrics:
        ...
        if not isinstance(metric, Metric):
            raise ValidationError(
                "Specified metric is not of type movern.metric.Metric"
            )
